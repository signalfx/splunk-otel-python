...
def test_realm():
    ...
    configure_distro(env_store)
    assert env_store["OTEL_EXPORTER_OTLP_TRACES_ENDPOINT"] == "https://ingest.us2.observability.splunkcloud.com/v2/trace/otlp"
    assert env_store["OTEL_EXPORTER_OTLP_METRICS_ENDPOINT"] == "https://ingest.us2.observability.splunkcloud.com/v2/datapoint/otlp"
