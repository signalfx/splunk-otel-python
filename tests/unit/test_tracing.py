...
class TestTracing(TestCase):
    ...
    def test_do_start_tracing_with_defaults(self):
        ...
        self.assertIsInstance(get_global_response_propagator(), _ServerTimingResponsePropagator)
    ...
    def test_do_start_tracing_with_resource_attrs(self):
        tracer_provider = _do_start_tracing(_FakeEnvVars(), resource_attributes={'my.attr': 42})
        expected_attrs = {
            'telemetry.sdk.language': 'python',
            'telemetry.sdk.name': 'opentelemetry',
            'telemetry.sdk.version': '1.19.0',
