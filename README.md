...
<p align="center">
  <span class="otel-version-badge"><a href="https://github.com/open-telemetry/opentelemetry-python/releases/tag/v1.11.1"><img alt="OpenTelemetry Python Version" src="https://img.shields.io/badge/otel-1.11.1-blueviolet?style=for-the-badge"/></a></span>
...
* OpenTelemetry API version <span class="otel-api-version">1.11.1</span>
* OpenTelemetry SDK version <span class="otel-sdk-version">1.11.1</span>
* OpenTelemetry Instrumentation for Python version <span class="otel-instrumentation-version">0.30b1</span>
