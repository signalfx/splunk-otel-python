...
<p align="center">
  <span class="otel-version-badge"><a href="https://github.com/open-telemetry/opentelemetry-python/releases/tag/v1.9.0"><img alt="OpenTelemetry Python Version" src="https://img.shields.io/badge/otel-1.9.0-blueviolet?style=for-the-badge"/></a></span>
...
The Splunk Distribution of OpenTelemetry Python version <span class="splunk-version">1.4.0</span> is compatible
with:

* OpenTelemetry API version <span class="otel-api-version">1.9.0</span>
* OpenTelemetry SDK version <span class="otel-sdk-version">1.9.0</span>
* OpenTelemetry Instrumentation for Python version <span class="otel-instrumentation-version">0.28b0</span>
