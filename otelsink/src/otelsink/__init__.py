...
from otelsink.private import _LogsServiceServicer, _MetricsServiceServicer, _TraceServiceServicer
...
class GrpcSink:
    """
    This is a simple OTel GRPC server to which you can send metrics, traces, and
...
class PrintHandler(RequestHandler):
    """
    A simple RequestHandler implementation that prints the received messages.
    """
